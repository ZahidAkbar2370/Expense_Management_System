...
<div class="container">
    <div class="row justify-content-center">
        ...
        <div class="col-md-9">
            <div class="card">
                <div class="card-header"><center><h1 style="margin-bottom: 50px">{{ __('Register') }}</h1></center></div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="mobile_no" type="number" class="form-control" name="mobile_no" required autocomplete="new-password" placeholder="Enter Mobile No">
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-0">
                            ...
                            <div class="col-md-6">
                                ...
                                <br><br>
                                <a href="{{url('login')}}">Have already Account! <b>Login</b></a>
                            </div>
                        </div>
